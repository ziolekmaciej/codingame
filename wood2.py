...
class Site:
    ...
    def update(self, structure_type, owner):  
...
class Sites:
    ...
    def lowest_distance(self, coords):
        x, y = coords
        free_sites = [site for site in self.sites if site.can_build() and site.check_half(x)]
...
class Game:
    ...
    def generate_action(self):                            
        ...
        elif self.sites.lowest_distance(self.safe_position) != -1:
            print("BUILD " + str(self.sites.lowest_distance(self.safe_position)) + " TOWER")
        else:
            x, y = self.safe_position
